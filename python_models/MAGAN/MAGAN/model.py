...
class MAGAN(object):
    ...
    def __init__(self,
        ...
        self.dim_b1 = dim_b1[-1]
        self.dim_b2 = dim_b2[-1]
        ...
        self.xb1 = tf.placeholder(tf.float32, shape=dim_b1, name='xb1')
        self.xb2 = tf.placeholder(tf.float32, shape=dim_b2, name='xb2')
